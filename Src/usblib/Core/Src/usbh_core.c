...
/**
  ...
  * @retval USBH Status
  */
USBH_StatusTypeDef USBH_Init(USBH_HandleTypeDef *phost, void (*pUsrFunc)(USBH_HandleTypeDef *phost, uint8_t), void (*pUsrFunc2)(USBH_HandleTypeDef *phost), uint8_t id)
{
